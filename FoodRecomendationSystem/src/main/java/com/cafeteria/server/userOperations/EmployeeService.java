...
public class EmployeeService {
    ...
    public JSONObject castVote(VotingItem voteItem) {
        if (!menueService.checkFoodId(voteItem.getFoodItemId())
                || !rolloutService.checkRolloutMenuItem(voteItem.getRolloutID())) {
            jsonResponse.put("error", "Food Item or Rollout ID is not present So Please check Menu ");
